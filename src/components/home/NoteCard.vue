<template>
    <div class="card">
        <div class="card-body pb-0" v-if="post.note">
            {{post.note}}
        </div>
        <hr class="mt-3">
        <div class="card-body">
            <div class="d-flex flex-row justify-content-between align-items-center pb-3">
                <div class="d-flex align-items-center">
                    <i class="material-icons pr-2 pointer" aria-label="true" @click.stop="onToggleLike">{{noteLiked === true? 'favorite': 'favorite_outline'}}</i>
